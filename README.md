...
| ------------- | ------------- |------------- |------------- | ------------- | ------------- | ------------- | ------------- |
| [Labyrinth](https://labyrinth.technology/) | A Multichain Modular Privacy Framework with a Decentralized Compliance Network | - | TBD | EVM chains | - | [Docs](https://labyrinth.gitbook.io/labyrinth) | - |
